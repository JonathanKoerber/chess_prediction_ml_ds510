...
from variable_setting import loss_function,optimizer,iterations,len_episodes,frame_count,max_steps_per_episode,epsilon_interval,epsilon_random_frames,epsilon_greedy_frames,epsilon_min,update_target_network
